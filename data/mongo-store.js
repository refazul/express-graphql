...
mongoose.connect('mongodb://' + process.env.db_user + ':' + process.env.db_pass + '@' + process.env.db_host + ':' + process.env.db_port + '/' + process.env.db_name + '?authSource=admin&readPreference=primary&directConnection=true&ssl=false', {
